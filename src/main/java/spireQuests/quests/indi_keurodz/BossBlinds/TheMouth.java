...
public class TheMouth {
    private static AbstractCard.CardType firstCardType = null;
    public static final String GLOW_ID = Anniv8Mod.makeID("TheMouth");
    ...
    public static class MouthPenaltyPatch {
        ...
        public static void MouthPenalty(AbstractPlayer __instance, AbstractCard c) {
            if (!ImageField.CheckMarks(AbstractDungeon.currMapNode, BalatroQuest.ID, BossBlind.Mouth.frames))
                return;
            if (firstCardType != null && firstCardType != c.type) {
        ...
        public static void addGlow() {
            ...
            CardBorderGlowManager.addGlowInfo(new CardBorderGlowManager.GlowInfo() {
                ...
                public boolean test(AbstractCard card) {
                    return firstCardType != null && card.type != firstCardType;
                }
